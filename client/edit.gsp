                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: clientData, field: 'provider', 'errors')}">
                                    <g:select name="provider" from="${com.bssi.Provider.list()}" multiple="yes" optionKey="id" size="5" value="${clientData?.provider*.id}" />
                                </td>
                            </tr>
