    ...
    <body>        
        <div class="body">
            ...
            <g:form method="post">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'comments', 'errors')}">
                                    <g:textField name="comments" value="${ruleData?.comments}" />
                                </td>
                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name" colspan="2">
                                    ----------------------- Coding Here --------------------------<Br/>
                                    Message variable name:  msg
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" colspan="2" class="value ${hasErrors(bean: ruleData, field: 'other', 'errors')}">
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="updateCode" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
