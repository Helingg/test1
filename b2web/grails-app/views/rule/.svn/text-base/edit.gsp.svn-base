    ...
    <body>        
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${ruleData?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'groupId', 'errors')}">
                                    <g:textField name="groupId" value="${fieldValue(bean: ruleData, field: 'groupId')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'operator', 'errors')}">
                                    <g:textField name="operator" maxlength="16" value="${ruleData?.operator}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="value"><g:message code="rule.value.label" default="Value" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'value', 'errors')}">
                                    <g:textArea name="value" cols="40" rows="5" value="${ruleData?.value}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="other"><g:message code="rule.other.label" default="Other" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'other', 'errors')}">
                                    <g:textArea name="other" cols="40" rows="5" value="${ruleData?.other}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: ruleData, field: 'comments', 'errors')}">
                                    <g:textArea name="comments" cols="40" rows="5" value="${ruleData?.comments}" />
                                </td>
                            </tr>
